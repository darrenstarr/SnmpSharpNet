...
namespace System
{
    public static class SocketExtensions
    {
        ...
        public static Task<ReceiveFromResult> ReceiveFromAsync(this Socket socket, byte[] buffer, int offset, int count)
        {
            return socket.ReceiveFromAsync(buffer, offset, count, SocketFlags.None);
        }

        public static Task<ReceiveFromResult> ReceiveFromAsync(this Socket socket, ArraySegment<byte> segment)
        {
            return socket.ReceiveFromAsync(segment.Array, segment.Offset, segment.Count);
        }
